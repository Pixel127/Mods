...
namespace ImprovedWorkbenches
{
    public class Main : HugsLib.ModBase
    {
        ...
        {
            Logger.Error("Original mod has been updated! so you don't need to use this mod now. -> https://steamcommunity.com/sharedfiles/filedetails/?id=935982361");
            Logger.Error("Unsub this mod and resub the original one please!");
